...
export declare class CachingGLTFLoader<T extends GLTFInstanceConstructor = GLTFInstanceConstructor> {
     ...
     * copy.
     */
    load(url: string, progressCallback?: ProgressCallback): Promise<InstanceType<T>>;
}
export {};
